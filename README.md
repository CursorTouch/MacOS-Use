<div align="center">
  ...
  <h1>🍎 MacOS-Use</h1>
  <a href="https://pepy.tech/project/macos-use">
    <img src="https://static.pepy.tech/badge/macos-use" alt="PyPI Downloads">
  </a>
  <a href="https://github.com/CursorTouch/macos-use/blob/main/LICENSE">
...
- [PyObjC](https://pyobjc.readthedocs.io/) — macOS Accessibility API bindings

## 🤝 Contributing

Contributions are welcome! See [CONTRIBUTING](CONTRIBUTING.md) for the development workflow.
