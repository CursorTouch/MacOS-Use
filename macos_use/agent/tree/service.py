from macos_use.agent.tree.config import INTERACTIVE_ACTIONS, INTERACTIVE_ROLES, CONTAINER_ROLES, SCROLLABLE_ROLES, WINDOW_CONTROL_SUBROLES
from macos_use.agent.tree.views import TreeState, TreeElementNode, ScrollElementNode, TextElementNode, BoundingBox, Center
from concurrent.futures import ThreadPoolExecutor, as_completed
from macos_use.agent.desktop.config import BROWSER_BUNDLE_IDS, SYSTEM_UI_BUNDLE_IDS
from macos_use.agent.desktop.views import Status, Window
...
class Tree:
    ...
    def tree_traversal(self, control: ax.Control, window_name: str, interactive_nodes: list[TreeElementNode], scrollable_nodes: list[ScrollElementNode], dom_informative_nodes: list, is_browser: bool) -> None:
        """
        ...
        AXUIElementCopyMultipleAttributeValues, replacing individual GetAttribute calls.
        """
