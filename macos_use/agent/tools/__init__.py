...
scrape_tool, desktop_tool, memory_tool, multi_select_tool, multi_edit_tool)

BUILTIN_TOOLS = [click_tool, type_tool, app_tool, shell_tool, done_tool,
shortcut_tool, scroll_tool, move_tool, wait_tool,
scrape_tool, memory_tool, multi_select_tool, multi_edit_tool]

EXPERIMENTAL_TOOLS = [desktop_tool]
