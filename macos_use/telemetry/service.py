from macos_use.telemetry.views import BaseTelemetryEvent
...
class ProductTelemetry:
    ...
    def user_id(self):
        ...
        temp_dir = Path(os.path.join(os.environ.get('TEMP', os.environ.get('TMP', '/tmp')), '.macos-use'))
        temp_dir.mkdir(parents=True, exist_ok=True)
        user_id_file = temp_dir / '.macos-use-user-id'
